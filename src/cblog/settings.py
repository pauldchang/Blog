...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'admin12345',
        'HOST': 'blog-application-db.c1wgcmskqb38.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogs3paulchangblog' # please enter your s3 bucket name
